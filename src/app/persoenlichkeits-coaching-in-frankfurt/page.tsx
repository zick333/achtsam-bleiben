...
const ablauf = [
  {
    num: '01',
    label: 'Start',
    title: 'Kennenlernen & Zielklärung',
    text: 'Wir klären Erwartungen, Themen und Erfolgskriterien. Was beschäftigt dich? Was soll sich verändern? Dieser erste Schritt legt das Fundament für alles Weitere.',
  },
  {
    num: '02',
    label: 'Analyse',
    title: 'Status-Quo-Analyse',
    text: 'Ressourcen, Werte und aktuelle Herausforderungen werden sichtbar gemacht. Du bekommst ein klareres Bild davon, wo du wirklich stehst – und was dich antreibt.',
  },
  {
    num: '03',
    label: 'Achtsamkeit',
    title: 'Achtsamkeits-Check-In',
    text: 'Kurze Atem- oder Body-Scan-Sequenzen, um Fokus und Selbstwahrnehmung zu schärfen. Der Körper weiß oft mehr als der Kopf – wir lernen, auf ihn zu hören.',
  },
  {
    num: '04',
    label: 'Methodik',
    title: 'Methoden-Mix',
    text: 'Systemische Perspektivwechsel, Wertearbeit, Visualisierungen und achtsame Reflexion. Jede Session ist so gestaltet, dass sie dich wirklich weiterbringt.',
  },
  {
    num: '05',
    label: 'Transfer',
    title: 'Transfer & Review',
    text: 'Konkrete Aktionsschritte und Zwischenreflexion, um Fortschritte zu verankern. Was nimmst du mit? Welcher nächste Schritt ist realistisch und sinnvoll?',
  },
];
...
const zielgruppen = [
  {
    ...
    items: [
      'Klarer entscheiden unter Druck',
      'Authentischer führen',
      'Innere Ruhe als Führungsqualität',
      'Konflikte konstruktiv lösen',
    ],
  },
  {
    category: 'Umbruchs­situationen',
    items: [
      'Jobwechsel & Neuorientierung',
  ...
  {
    category: 'Selbstständige & Kreative',
    items: [
      'Fokus bewahren',
      'Innere Blockaden lösen',
      'Selbstwirksamkeit stärken',
      'Energien gezielt einsetzen',
    ],
  },
  {
    category: 'Persönlichkeits­entwicklung',
    items: [
      'Werte & Prioritäten klären',
...
export default function PersoenlichkeitsCoachingPage() {
  useScrollReveal();
      ...
      <section className="relative min-h-[85dvh] flex items-end overflow-hidden">
        ...
        <div className="relative w-full max-w-[1400px] mx-auto px-4 pb-16 md:pb-24">
          ...
          <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-white leading-[0.95] tracking-tight mb-8 max-w-3xl">
            Persönlichkeits-<br />Coaching
          </h1>
          <p className="text-white/50 text-sm md:text-base max-w-md leading-relaxed mb-8">
            Stärken erkennen, Muster aufdecken, konkrete Schritte gehen —
            beruflich wie privat, mit Kopf, Herz und Körper.
          </p>
              ...
              <div className="p-2 rounded-[2rem] ring-1 ring-black/5 bg-stone-50">
                <div className="relative aspect-[3/4] rounded-[calc(2rem-0.5rem)] overflow-hidden"
                  ...
                  <Image
                    ...
                    alt="Holm Zickermann – Persönlichkeits-Coach in Frankfurt"
                    fill
            ...
            <div className="flex flex-col gap-8">
              <div className="reveal reveal-delay-1">
                ...
                <p className="text-gray-600 text-lg leading-relaxed">
                  Persönlichkeits-Coaching ist ein zielgerichteter Prozess, der dich dabei
                  unterstützt, deine Stärken klarer zu sehen, hinderliche Muster aufzudecken
                  und konkrete Schritte hin zu einem erfüllteren Leben zu gehen – beruflich
                  wie privat.
                </p>
              </div>
              ...
              <div className="reveal reveal-delay-2">
                <div className="relative pl-7 border-l-2 border-[#E8913A]">
                  <p className="font-serif text-2xl md:text-3xl italic text-[#1C1410] leading-snug mb-4">
                    „Wir kombinieren bewährte Coaching-Methoden mit achtsamkeitsbasierten Übungen, damit Kopf, Herz und Körper gleichermaßen eingebunden sind."
                  </p>
            ...
            {[
              {
                icon: '◎',
                title: 'Klarheit',
                text: 'Über Ziele, Werte und Prioritäten – du weißt, wohin du willst und warum.',
              },
              {
                icon: '◈',
                title: 'Resilienz',
                text: 'Durch achtsamkeitsbasierte Stresskompetenz lernst du, mit Druck souveräner umzugehen.',
              },
              {
                icon: '◇',
                title: 'Selbst­wirksamkeit',
                text: 'Dank konkreter Handlungspläne erlebst du dich als gestaltendes Subjekt deines Lebens.',
              },
              {
                icon: '○',
                title: 'Authentizität',
                text: 'In Beziehungen und Führungssituationen wirkst du echter, klarer und verbindlicher.',
              },
            ].map((item, i) => (
              <div
                key={item.title}
              ...
              >
                <span className="text-[#E8913A]/40 text-3xl block mb-5 font-serif">{item.icon}</span>
      ...
      <section className="py-20 md:py-24 bg-stone-50 border-y border-stone-100">
        <div className="reveal max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="font-serif text-2xl md:text-4xl italic text-[#1C1410] leading-snug mb-6"
            ...
            „Vereinbare dein unverbindliches Erstgespräch und finde heraus, wie achtsamkeitsbasiertes Coaching dich unterstützen kann."
          </p>
        ...
        <div className="relative max-w-[1400px] mx-auto px-4 text-center">
          <div className="reveal">
            ...
            <p className="text-white/75 text-base mb-12 tracking-wide max-w-md mx-auto leading-relaxed">
              Unverbindliches Erstgespräch – ich melde mich zeitnah bei dir.
            </p>
            <Link
              href="/kontakt/"
